...
public class SeparatedLeaves {
    ...
    public static final TagKey<Biome> ALLOW_MISMATCHED_LEAVES_BIOMES = TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(MOD_ID, "allow_mismatched_leaves"));
